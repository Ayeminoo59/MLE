...
"""
နောင်ကို ဒါမျိုးမဖြစ်အောင် ဘယ်လိုလုပ်ရမလဲ?

ကုဒ်တွေ မပြင်ခင်နဲ့ ကုဒ်တွေ မတင်ခင်မှာ အမြဲတမ်း git pull အရင်လုပ်ပေးပါ။

အလုပ်မစခင်: git pull (GitHub က အသစ်တွေကို အရင်ယူ)

ကုဒ်တွေ ပြင်မယ်: git add . -> git commit -m "..."

အလုပ်သိမ်းရင်: git push (ကိုယ့်ဟာကို ပြန်တင်)
"""